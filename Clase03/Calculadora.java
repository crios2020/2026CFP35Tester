    ...
    public static void main(String[] args) {
        if (args.length >= 3) {
            try {
                ...
                if(operacion.equalsIgnoreCase("sumar")) System.out.println(nro1+nro2);
                if(operacion.equalsIgnoreCase("restar")) System.out.println(nro1-nro2);
                ...
                if(operacion.equalsIgnoreCase("multiplicar")) System.out.println(nro1*nro2);
                if(
